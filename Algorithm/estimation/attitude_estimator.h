...
uint8_t Bmi270Driver_TemperatureRawToC(int16_t raw, float *temperature_c);
uint8_t Bmi270Driver_RawFrameHasSignal(const int16_t accel_raw[3], const int16_t gyro_raw[3]);
uint8_t
Bmi270Driver_GyroCalSpanWithinLimit(const float min_dps[3], const float max_dps[3], float max_span_dps, uint8_t *axis);
