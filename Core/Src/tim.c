...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE14     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = M1_IN1_Pin|M2_IN1_Pin|M3_IN1_Pin|M4_IN1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOC, M1_IN2_Pin|M2_IN2_Pin|M3_IN2_Pin|M4_IN2_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(M1_ENC_A_GPIO_Port, M1_ENC_A_Pin);

    HAL_GPIO_DeInit(M1_ENC_B_GPIO_Port, M1_ENC_B_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, M3_ENC_A_Pin|M3_ENC_B_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA1     ------> TIM5_CH2
    */
    HAL_GPIO_DeInit(GPIOA, M4_ENC_A_Pin|M4_ENC_B_Pin);
