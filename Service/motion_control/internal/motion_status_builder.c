                                            ...
                                            uint8_t                              control_source)
{
    ...
    snapshot->pwm_saturated = (uint8_t)(MotionStatusBuilder_Abs((float)snapshot->left_output_permille) >= 850.0f
                                        || MotionStatusBuilder_Abs((float)snapshot->right_output_permille) >= 850.0f);
}
