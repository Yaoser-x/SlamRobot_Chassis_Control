...
static uint8_t TelemetryFrameBuilder_ImuFlags(const communication_publish_imu_t *imu)
{
    uint8_t flags = 0U;
                                               ...
                                               uint16_t                             out_len)
{
    ...
    uint8_t                    payload[UPPER_PROTOCOL_DIAGNOSTIC_PAYLOAD_LEN];
    uint8_t                    payload_len;
    ...
    diagnostic.imu_status_flags         = TelemetryFrameBuilder_ImuFlags(&snapshot->imu);
                                        ...
                                        uint16_t                             out_len)
{
    ...
    imu.status_flags  = TelemetryFrameBuilder_ImuFlags(&snapshot->imu);
