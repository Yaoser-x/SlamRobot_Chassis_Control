...
#define UPPER_PROTOCOL_VERSION                   COMMUNICATION_PROTOCOL_VERSION
#define UPPER_PROTOCOL_MAX_PAYLOAD               COMMUNICATION_MAX_PAYLOAD_LENGTH
...
#define UPPER_PROTOCOL_STATUS_PAYLOAD_LEN        COMMUNICATION_STATUS_PAYLOAD_LENGTH
...
#define UPPER_PROTOCOL_IMU_STATUS_PAYLOAD_LEN    COMMUNICATION_IMU_STATUS_PAYLOAD_LENGTH
#define UPPER_PROTOCOL_DIAGNOSTIC_PAYLOAD_LEN    COMMUNICATION_DIAGNOSTIC_PAYLOAD_LENGTH
#define UPPER_PROTOCOL_DIAGNOSTIC_SCHEMA_VERSION COMMUNICATION_DIAGNOSTIC_SCHEMA_VERSION
