...
size_t DebugStraightTelemetry_FormatJson(char *buffer,
                                         size_t buffer_size,
                                         const chassis_control_state_t *chassis,
                                         const adc_monitor_state_t *adc)
{
  ...
  written = snprintf(buffer, buffer_size,
                     ...
                     chassis->left_actual_mps, chassis->right_actual_mps,
                     (uint8_t)(chassis->left_speed_valid && chassis->right_speed_valid),
                     chassis->pwm_saturated, chassis->control_source, adc->battery_voltage,
                     chassis->straight_direction, chassis->straight_transition_distance_m,
                     chassis->straight_trim_mps, chassis->straight_wheel_correction_mps,
                     chassis->straight_heading_error_deg, chassis->straight_heading_integral_deg_s,
                     chassis->straight_heading_correction_mps, chassis->straight_total_correction_mps,
