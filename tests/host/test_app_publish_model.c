...
int main(void)
{
    ...
    const app_publish_model_config_t config = {
    ...
    SeedInputs();
    assert(AppPublishModel_Init(&config) != 0U);
    assert(AppPublishModel_Get(0) == 0U);
    assert(AppPublishModel_Get(&snapshot) == 0U);
    AppPublishModel_Update(1000U);
    assert(AppPublishModel_Get(&snapshot) == 1U);
    ...
    AppPublishModel_Update(2000U);
    assert(AppPublishModel_Get(&snapshot) == 2U);
