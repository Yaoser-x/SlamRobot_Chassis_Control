...
int main(void)
{
  chassis_control_state_t chassis = {0};
  ...
  check(strstr(header, "requested_mps,target_mps,actual_left_mps,actual_right_mps,speed_valid,pwm_saturated,source,battery_v") != NULL,
