...
int main(void)
{
  ...
  view = OLED_CalibrationView_Build(IMU_BMI270_GYRO_AUTO_CAL_WAIT, 0U, 100U,
                                    IMU_BMI270_GYRO_CAL_FAIL_MOTION, 10U, 0U);
  ...
  view = OLED_CalibrationView_Build(IMU_BMI270_GYRO_AUTO_CAL_RUNNING, 25U, 100U, 0U, 10U, 0U);
  require_int(view.progress_percent == 25U, "sample progress");
  view = OLED_CalibrationView_Build(IMU_BMI270_GYRO_AUTO_CAL_DONE, 100U, 100U, 0U, 3999U, 1000U);
  require_int(view.visible && !view.return_to_normal, "terminal view retained");
  view = OLED_CalibrationView_Build(IMU_BMI270_GYRO_AUTO_CAL_FAILED, 10U, 100U, 1U, 4000U, 1000U);
  require_int(!view.visible && view.return_to_normal, "terminal auto return");
  view = OLED_CalibrationView_Build(IMU_BMI270_GYRO_AUTO_CAL_FAILED, 0U, 100U,
                                    IMU_BMI270_GYRO_CAL_FAIL_READ, 3000U, 0U);
