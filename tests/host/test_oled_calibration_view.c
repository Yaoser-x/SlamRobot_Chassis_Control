...
int main(void)
{
    ...
    view =
        OLED_CalibrationView_Build(IMU_BMI270_GYRO_AUTO_CAL_WAIT, 0U, 100U, IMU_BMI270_GYRO_CAL_FAIL_MOTION, 10U, 0U);
    ...
    view =
        OLED_CalibrationView_Build(IMU_BMI270_GYRO_AUTO_CAL_FAILED, 0U, 100U, IMU_BMI270_GYRO_CAL_FAIL_READ, 3000U, 0U);
