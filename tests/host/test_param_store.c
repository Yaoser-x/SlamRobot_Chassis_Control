...
static void test_defaults_match_safe_runtime_values(void)
{
  ...
  require_close(params.straight_wheel_coupling_gain, 0.30f, 0.0001f,
                "straight coupling default 0.30");
  require_close(params.straight_heading_kp, 0.0f, 0.0001f,
                "straight heading kp defaults safe off");
  require_close(params.straight_heading_ki, 0.0f, 0.0001f,
                "straight heading ki defaults safe off");
  require_close(params.straight_max_speed_mps, 0.30f, 0.0001f,
                "straight maximum speed defaults to HIL ceiling");
  require_int(params.straight_heading_hold_enabled == 0U,
              "straight heading hold disabled until HIL");
...
static void test_named_float_set_get_rejects_unsafe_values(void)
{
  ...
  require_int(ParamStore_SetFloat(&params, "straight_trim_forward_015_mps", -0.10f) == 1U,
              "accept trim lower bound");
  require_int(ParamStore_SetFloat(&params, "straight_trim_reverse_030_mps", 0.10f) == 1U,
              "accept trim upper bound");
  require_int(ParamStore_SetFloat(&params, "straight_trim_forward_030_mps", 0.101f) == 0U,
              "reject trim above bound");
  require_int(ParamStore_SetFloat(&params, "straight_heading_ki", 0.02f) == 1U,
              "accept heading ki upper bound");
  require_int(ParamStore_SetFloat(&params, "straight_heading_ki", 0.021f) == 0U,
              "reject heading ki above bound");
...
static void test_named_int_set_get_and_range_check(void)
{
  ...
  require_int(params.straight_heading_hold_enabled == 1U,
              "heading hold stored as 1");
  ...
  require_int(ParamStore_GetInt(&params, "line_active_low", &value) == 1U,
              "get line_active_low");
  require_int(value == 1, "default line_active_low = 1");
  require_int(ParamStore_SetInt(&params, "line_active_low", 0) == 1U,
              "set line_active_low = 0");
  require_int(ParamStore_SetInt(&params, "line_active_low", 2) == 0U,
              "reject line_active_low = 2");
  ...
  require_int(ParamStore_GetInt(&params, "current_fault_debounce_ms", &value) == 1U,
  ...
  /* ----- unknown name ----- */
  require_int(ParamStore_SetInt(&params, "not_a_param", 1) == 0U,
              "reject unknown int param");
  require_int(ParamStore_GetInt(&params, "not_a_param", &value) == 0U,
              "get unknown int param returns 0");
}
