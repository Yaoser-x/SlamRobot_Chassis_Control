  ...
  <main>
    ...
    <section class="control">
      ...
      <div class="panel">
        ...
        <div class="buttons"><button class="btn stop" id="btnStop">停止</button><button class="btn estop" id="btnEstop">急停</button><button class="btn line" id="btnLine">巡线关</button></div>
      </div>
    </section>
  </main>
</div>
