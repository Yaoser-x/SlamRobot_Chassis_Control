...
static void ImuCalibrationGate_ResetEvidence(imu_calibration_gate_t *gate, uint32_t imu_sample_count)
{
...
uint8_t ImuCalibrationGate_Update(imu_calibration_gate_t *gate,
