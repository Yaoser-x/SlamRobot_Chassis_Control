...
uint8_t LineCalibration_Begin(line_calibration_t *calibration, line_calibration_surface_t surface, uint16_t samples);
/** Feed one eight-channel raw sample into the active collection. */
void LineCalibration_Feed(line_calibration_t *calibration, const uint16_t raw[LINE_CALIBRATION_CHANNELS]);
